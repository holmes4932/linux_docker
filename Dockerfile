...
RUN apt-get install -y gcc gdb make yasm nasm tcpdump libunwind-dev libseccomp-dev libcapstone-dev libncurses-dev python3 python3-pip python3-virtualenv
RUN apt-get install -y gcc-multilib g++-multilib
RUN apt-get install -y libc6-dbg dpkg-dev
RUN apt-get install -y curl git zsh
RUN apt-get install -y qemu-system-x86 autoconf automake libtool
